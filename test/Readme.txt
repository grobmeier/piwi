...
To run all tests with covering report invoke (REPORT_DIRECTORY is the directory where the reports will be placed):
php test/TestRunner.php REPORT_DIRECTORY PHPCOVERAGE_HOME=test/spikephpcoverage-0.8.2/src
